          ...
          <div className="flex min-w-0 w-[60%] flex-col gap-5 max-lg:w-full max-sm:order-1 max-sm:gap-4">
            ...
            <div className="text-p1 text-muted [&>p+p]:mt-5 max-sm:text-[14px] max-sm:leading-[1.5] max-sm:[&>p+p]:mt-4">
              ...
              <p>
                ...
                <ContentLink href="/solutions/head-end-system-hes">
                  Head-End System (HES)
                </ContentLink>
                ,{" "}
                <ContentLink href="/solutions/meter-data-management-system-mdms">
                  Meter Data Management System (MDMS)
                </ContentLink>{" "}
                and analytics capabilities to build intelligence from the data
                source upwards — connecting meter and consumption information with
                consumer, asset and network context.
              </p>
              <p>
